...
p = 0.65
x = 58 # of people with "free" earlobes written on the board here
n = 68 #total number of individuals here
...
##Calculate effect size using the cohen's D
library(lsr)
...
##sample size calcs.
library("pwr")
pwr.t.test(power=0.80,d=0.1887037,sig.level=0.05,alternative="two.sided")
